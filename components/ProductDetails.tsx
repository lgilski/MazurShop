...
function ProductDetails({ product }) {
  ...
  return (
    <div className='max-w-7xl  mx-auto  mb-16 mt-16 p-4 bg-white rounded-2xl shadow-md'>
      <section className='grid grid-cols-[2fr_1fr] gap-8'>
        ...
        <div className='pt-8 relative flex flex-col'>
          {/* {product.discount && (
            <p className='absolute flex w-16 h-16 items-center justify-center top-0 right-0 text-xl font-medium p-1 bg-purple-200 text-purple-900 rounded-full'>
            -{product.discount}%
            </p>
          )} */}
          ...
          <div className='flex flex-col mb-20'>
            <button className='text-xl flex-grow bg-green-700 px-4 py-2 rounded-full text-green-050 hover:bg-green-500 duration-200 mb-4'>
              Add to cart
            </button>
